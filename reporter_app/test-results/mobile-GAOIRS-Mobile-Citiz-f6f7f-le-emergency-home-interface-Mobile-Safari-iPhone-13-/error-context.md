...
- Name: mobile.spec.js >> GAOIRS Mobile Citizen App Black-Box Test Suite >> should render mobile emergency home interface
- Location: tests\mobile.spec.js:7:7
...
Locator: getByText(/Emergency Report/i).first()
Expected: visible
Timeout: 15000ms
