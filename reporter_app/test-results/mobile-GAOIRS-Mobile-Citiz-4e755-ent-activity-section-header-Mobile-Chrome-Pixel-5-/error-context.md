...
- Name: mobile.spec.js >> GAOIRS Mobile Citizen App Black-Box Test Suite >> should display recent activity section header
- Location: tests\mobile.spec.js:19:7
...
Locator: getByText(/RECENT ACTIVITY/i).first()
Expected: visible
Timeout: 15000ms
