...
fs.writeFileSync('backend/src/services/alertService.js', alertServiceContent);
fs.writeFileSync('backend/src/services/smsService.js', smsServiceContent);
fs.writeFileSync('backend/src/services/emailService.js', emailServiceContent);
fs.writeFileSync('backend/src/services/socketService.js', socketServiceContent);
